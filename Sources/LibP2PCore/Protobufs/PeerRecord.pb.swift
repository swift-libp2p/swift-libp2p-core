...
// Source: Sources/LibP2PCore/Protobufs/PeerRecord.proto
//
...
/// PeerRecord messages contain information that is useful to share with other
/// peers. Currently, a PeerRecord contains the public listen addresses for a
/// peer, but this is expected to expand to include other information in the
/// future.
///
...
struct PeerRecordMessage: Sendable {
  ...
  /// seq contains a monotonically-increasing sequence counter to order
  /// PeerRecords in time.
  var seq: UInt64 = 0
...
extension PeerRecordMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}peer_id\0\u{1}seq\0\u{1}addresses\0")
...
extension PeerRecordMessage.AddressInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}multiaddr\0")
